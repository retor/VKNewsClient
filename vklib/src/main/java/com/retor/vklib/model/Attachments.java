...
import com.retor.vklib.model.attachments.AttachList;
 ...
 */
public class Attachments <T extends AttachModel> implements List<T>, Parcelable {
    private List<T> list = new ArrayList<>();

    public Attachments(final List<T> list) {
        this.list = list;
    }

    public Attachments(T... items) {
